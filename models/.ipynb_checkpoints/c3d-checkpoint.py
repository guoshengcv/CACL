...
class C3D(nn.Module):
    ...
    def __init__(self, with_classifier=False, retrival_test=False, retrival_test_p4=False, return_conv=False, num_classes=101):
        super(C3D, self).__init__()
        self.with_classifier = with_classifier
        self.num_classes = num_classes
        self.return_conv = return_conv
        self.retrival_test = retrival_test
        self.retrival_test_p4 = retrival_test_p4
        ...
        self.relu4b = nn.ReLU()
        if self.retrival_test_p4:
            self.fc_pool4 = nn.AdaptiveAvgPool3d(1)
